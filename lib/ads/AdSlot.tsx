...
/** …continuously for 1s before counting as seen. */
...
/**
 * Attaches viewability tracking to element with beacon dispatch.
 */
...
/**
 * Default Ad Slot renderer styled to match AIHunt's warm editorial theme.
 */
export function AdSlot({
  ...
  return (
    <div
      ref={ref}
      className={`sponsor-ad-card ${className || ''}`}
      style={style}
    >
      <a
        href={ad.clickUrl}
