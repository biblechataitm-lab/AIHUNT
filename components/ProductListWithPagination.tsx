...
export function ProductListWithPagination({
  ...
  emptyDescription = 'There are no products matching this criteria yet. Check back soon or submit a product.',
  ...
  if (products.length === 0) {
    return (
      ...
      >
        <h3 style={{ fontSize: '20px', fontFamily: 'var(--font-display)', marginBottom: '8px', color: 'var(--color-ink)' }}>
          {emptyTitle}
        </h3>
        <p style={{ fontSize: '14px', color: 'var(--color-muted)', maxWidth: '420px', margin: '0 auto' }}>
          {emptyDescription}
        </p>
      </div>
    );
